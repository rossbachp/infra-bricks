...
sich der Einsatz von [serverspec](http://www.serverspec.org). Wer noch nicht so vertraut mit ServerSpec ist, sollte unseren [Einführungs- Post](http://www.infrabricks.de/blog/2014/04/25/serverspec-server-spezifizieren-und-testen/) dazu kurz lesen.
